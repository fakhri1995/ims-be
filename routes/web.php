...
$router->group(['middleware' => 'auth'], function ($router) {
    ...
    $router->get('/getAndroidActivities', 'AttendanceController@getAndroidActivities');
    ...
    $router->get('/getAttendancesUsersCompany', 'AttendanceController@getAttendancesUsersCompany');
    ...
    $router->get('/getAttendancesUsersPaginateCompany', 'AttendanceController@getAttendancesUsersPaginateCompany');
    ...
    $router->post('/setAttendanceToggleMobile', 'AttendanceController@setAttendanceToggleMobile');
    ...
    $router->put('/updateResumeSkill', 'ResumeController@updateResumeSkill');
    $router->delete('/deleteResumeSkill', 'ResumeController@deleteResumeSkill');
    $router->post('/addResumeEducation', 'ResumeController@addResumeEducation');
    $router->put('/updateResumeEducation', 'ResumeController@updateResumeEducation');
    $router->delete('/deleteResumeEducation', 'ResumeController@deleteResumeEducation');
    $router->post('/addResumeExperience', 'ResumeController@addResumeExperience');
    $router->put('/updateResumeExperience', 'ResumeController@updateResumeExperience');
    $router->delete('/deleteResumeExperience', 'ResumeController@deleteResumeExperience');
    $router->post('/addResumeLanguage', 'ResumeController@addResumeLanguage');
    $router->put('/updateResumeLanguage', 'ResumeController@updateResumeLanguage');
    $router->delete('/deleteResumeLanguage', 'ResumeController@deleteResumeLanguage');
    ...
    $router->delete('deleteResumeEvaluation', 'ResumeController@deleteResumeEvaluation');
    ...
    $router->get('/getPendingRecruitmentsAI', 'RecruitmentController@getPendingRecruitmentsAI');
