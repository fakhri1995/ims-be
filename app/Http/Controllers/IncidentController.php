    ...
    public function getIncidents(Request $request)
    {
        ...
        try{
            ...
            if($id === null){
                ...
                if($incidents->isEmpty()) return response()->json(["success" => false, "message" => "Incident Account Belum Terdaftar"]);
                ...
                return response()->json(["success" => true, "message" => "Data Berhasil Diambil", "data" => $incident]);
            }
        } catch(Exception $err){
