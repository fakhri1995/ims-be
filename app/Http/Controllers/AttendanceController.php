...
class AttendanceController extends Controller
{
    ...
    */
    ...
    public function getAttendanceFormCompany(Request $request)
    {
        ...
        $response = $this->attendanceService->getAttendanceFormCompany($request, $route_name);
        return response()->json($response, $response['status']);
    }
    ...
    public function getAttendanceActivitiesAdmin(Request $request)
    {
        $route_name = "ATTENDANCE_ACTIVITIES_ADMIN_GET";

        $response = $this->attendanceService->getAttendanceActivitiesAdmin($request, $route_name);
        return response()->json($response, $response['status']);
    }
    ...
    public function getAttendancesUsersCompany(Request $request)
    {
        $route_name = "ATTENDANCES_USERS_COMPANY_GET";

        $response = $this->attendanceService->getAttendancesUsersCompany($request, $route_name);
        return response()->json($response, $response['status']);
    }

    public function getAttendancesUserMonthly(Request $request)
    {
        $route_name = "ATTENDANCES_USER_MONTHLY_GET";

        $response = $this->attendanceService->getAttendancesUserMonthly($request, $route_name);
        return response()->json($response, $response['status']);
    }
    ...
    public function getAttendancesClient(Request $request)
    {
        $route_name = "ATTENDANCES_CLIENT_GET";

        $response = $this->attendanceService->getAttendancesClient($request, $route_name);
        return response()->json($response, $response['status']);
    }
    ...
    public function getAttendanceUserByDate(Request $request)
    {
        $route_name = "ATTENDANCE_USER_BY_DATE_GET";

        $response = $this->attendanceService->getAttendanceUserByDate($request, $route_name);
        return response()->json($response, $response['status']);
    }
   ...
   // Attendance Project 
    ...
    public function getUserAttendanceTaskActivitiesAdmin(Request $request)
    {
        $route_name = "USER_ATTENDANCE_TASK_ACTIVITIES_ADMIN_GET";

        $response = $this->attendanceService->getUserAttendanceTaskActivitiesAdmin($request, $route_name);
        return response()->json($response, $response['status']);
    }
