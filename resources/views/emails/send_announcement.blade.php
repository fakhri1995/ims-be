...
<body>
    <div style="width: 100%">
        ...
        {{-- @if ($data->thumbnailImage) --}}
            <img src="https://cdn.mig.id/{{ $data->thumbnailImage->link }}" alt="thumbnail_image"
                style="width: 50%; height: auto; padding-bottom: 1.5rem">
        {{-- @endif --}}
        ...
        <div style="width: 100%; text-align: center">
            <a class="blue-button" href="{{ env('APP_URL_WEB') . '/dashboard/announcement/detail/' . $data->id }}">
                Lihat Pesan
            </a>
        </div>
    </div>
